        ...
        <div className="card">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">Le client pourra le changer dans ses paramètres.</p>
            </div>

            {error && (
              <div className="bg-red-50 text-accent-red text-sm px-4 py-3 rounded-xl">{error}</div>
            )}
